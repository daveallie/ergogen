module.exports = {
  ...
  body: p => `
    (module ComboDiode (layer F.Cu) (tedit 5B24D78E)
      ...
      ${''/* Internal vias and traces */}
      ${p.param.internalVia ? `
          (pad 1 thru_hole circle (at -0.45 0) (size 0.6 0.6) (drill 0.3) (layers *.Cu) ${p.net.to.str})
          (pad 2 thru_hole circle (at 0.45 0) (size 0.6 0.6) (drill 0.3) (layers *.Cu) ${p.net.from.str})
      ` : ''}
    )`
}
